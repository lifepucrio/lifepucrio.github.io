  ...
  for (let pos=0; pos<calendario.length; pos+=18) {
    ...
    if (calendario[pos+7]!=" ") {
      ...
      if (calendario[pos+7]=='DSG1841'||calendario[pos+7]=='DSG1843'||
        ...
        calendario[pos+7]=='DSG1847'||calendario[pos+2]=='DSG1861'||calendario[pos+7]=='DSG1862'||
        ...
        calendario[pos+7]=='DSG1804'||calendario[pos+7]=='DSG1805'||calendario[pos+7]=='DSG1806'||calendario[pos+7]=='DSG1901'||calendario[pos+2]=='DSG1902') {
        //conteudos estruturantes
        fill(209, 163, 175, 150);
      }
      else {
