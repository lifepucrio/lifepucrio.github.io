function montaSerie() {
  ...
  for (let i=0; i<tabelaSerieHist.getRowCount(); i++) {
    ...
    if (prof.includes(qualProf)) {
      ...
      let creditos252=tabelaSerieHist.get(i, 'CH20252');
      ...
      line(pos251, 760-creditos251*30, pos252, 760-creditos252*30);
      line(pos252, 760-creditos252*30, pos261, 760-totalDeCreditos261*30);
      noStroke();
      fill(23, 173, 245, 150);
      ...
      ellipse(pos252, 760-creditos252*30, 10, 10);
      ellipse(pos261, 760-totalDeCreditos261*30, 10, 10);
      textAlign(CENTER);
      fill(0);
      ...
      text(creditos252+"cr", pos252, 760-creditos252*30);
      text(totalDeCreditos261+"cr", pos261, 760-totalDeCreditos261*30);
    }
  }
}
